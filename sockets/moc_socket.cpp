...
**
** Created: Tue May 22 20:05:01 2012
...
static const char qt_meta_stringdata_Socket[] = {
    "Socket\0\0conectar()\0"
};

const QMetaObject Socket::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Socket,
...
void *Socket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_MainWindow"))
        return static_cast< Ui_MainWindow*>(const_cast< Socket*>(this));
